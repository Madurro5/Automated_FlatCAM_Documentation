...
!!! tip "Tutoriel vidéo"
    ![type:video](../../assets/videos/Tutoriel_FlatCAMAUTO_AdvancedMode_Vcut_compressed.mp4)
...
| Paramètres d'isolement : | Paramètres de la tâche CNC : | Paramètres de perçage : |
|---|---|---|
| Diamètre d'outil | Diamètre d'outil | Diamètres de perçage |
| Passes | Profondeur de coupe | Profondeur de perçage |
| Chevauchement | Hauteur de déplacement | Profondeur par pas |
| Combinaison | Vitesse de déplacement | Déplacement en Z |
| Type d'isolement | Vitesse de déplacement axe Z | Vitesse de déplacement axe Z |
