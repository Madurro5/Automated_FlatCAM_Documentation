...
> → Avoir installé Automated FlatCAM en suivant l'aide de [la page principale](index.md#installation-du-logiciel) (FlatCAM Fork)
...
Une configuration comprend un ensemble de paramètres et options suivants. Ces paramètres sont détaillés et modifiables dans le [guide avancé](./guide-avance.md/#selectionner-la-configuration-dusinage).
...
| Paramètres de la tâche CNC : | Paramètres de perçage : |
|---|---|
| Diamètre d'outil | Diamètres de perçage |
| Profondeur de coupe | Profondeur de perçage |
| Hauteur de déplacement | Profondeur par pas |
| Vitesse de déplacement | Déplacement en Z |
| Vitesse de déplacement axe Z | Vitesse de déplacement axe Z |
| Hauteur de fin | Vitesse de broche |
| Vitesse de rotation de la broche | Préprocesseur |
| Temps d'arrêt | Changement d'outil et Hauteur de changement d'outil |
| Préprocesseur | |
...
> Si vous souhaitez allez plus loin dans le contrôle à cette étape de conversion notamment pour gérer certains paramètres d'usinages, d'alignement ou pour du double face plus maîtrisé alors dans ce cas poursuivre avec  → [le guide avancé d'Automated flatCAM](./guide-avance.md)