...
| [Le Fork FlatCAM](../developpement-flatcam-fork/index.md) | Pourquoi ce fork, ce qui diffère de la version officielle |
| [Installation du code](../developpement-flatcam-fork/installation-dev.md) | Mise en place de l'environnement de développement |
| [Code annoté](../developpement-flatcam-fork/code-annote.md) | Source commentée module par module |
| [Générateur de setup](../developpement-flatcam-fork/generateur-setup.md) | Fonctionnement du script de génération de setup |
...
Si vous souhaitez installer le code de FlatCAM Automatisé pour y apporter des modifications ou autre, veuillez vous référer à la page [d'installation de l'environnement et du code de FLATCAM Automatisé](../developpement-flatcam-fork/installation-dev.md).
