...
!!! quote "Qu'est-ce qu'un fork GitHub ?"
    ...
    **Source** : [docs.github.com](https://docs.github.com/fr/get-started/start-your-journey/about-github-and-git)
...
Pour installer correctement le code de cette version de FlatCAM, il faut se référer à [la page suivante](./installation-dev.md).
...
Enfin, pour générer à nouveau un installateur windows permettant d'installer cette version sur d'autres machines il faut suivre la page [Générateur de setup](./generateur-setup.md).


-> Première étape installer le code : [Installation du code](./installation-dev.md)