...
FlatCAM est le logiciel sélectionné pour convertir les fichiers Gerber exporté depuis KiCAD en fichiers d'usinage GCODE contenant des commandes exploitables par le contrôleur de la machine CNC.

!!! quote "Extrait de [flatcam.org](http://flatcam.org)"
    > PCB milling, also know as mechanical etching, is the fastest, cleanest, high-performance and economical PCB prototyping process today.
    > **FlatCAM** : FlatCAM lets you take your designs to a CNC router. You can open Gerber, Excellon or G-code, edit it or create from scatch, and output G-Code. Isolation routing is one of many tasks that FlatCAM is perfect for. It's is open source, written in Python and runs smoothly on most platforms. Check out the features list.
...
Ce logiciel est très complet et demande un certains temps de prise en main. Le Fork FlatCAM a été réalisé pour apporter des modifications au logiciel automatisant et simplifiant la conversion de Gerber vers GCODE.
...
| [Code annoté](code-annote.md) | Source commenté module par module |
| [Générateur de setup](generateur-setup.md) | Fonctionnement du script de génération de setup |


## Installation du logiciel

L'installation du logiciel FlatCAM version Automated s'effectue à l'aide de l'installateur `Automated_FlatCAM_Setup_8.994.exe` qui vous a été fourni en même temps que cette documentation ou téléchargeable **ici**.
...
Lancez l'executable et suivre les étapes suivantes.
...
Seul le français et l'anglais sont complètes pour cette version de FlatCAM.  

![Installation : étape 4](../../assets/images/Installateur-FlatCAM/Installateur_FlatCAM_4.jpg)

Démarrage de l'assitant d'installation. Appuyez sur `Suivant`.
...
>**Note :** Vous pouvez également désinstaller proprement le logiciel, un uninstaller est créé par l'installateur.
